...
@router.post("/collections/{collection_id}/sources", response_model=SourceResponse, tags=["sources"])
...
@router.get("/collections/{collection_id}/sources", response_model=list[SourceResponse], tags=["sources"])
...
@router.post("/sources/{source_id}/chunks", response_model=MemoryChunkResponse, tags=["chunks"])
async def create_chunk(
    ...
    source = db.query(Source).join(Collection).filter(
...
@router.get("/sources/{source_id}/chunks", response_model=list[MemoryChunkResponse], tags=["chunks"])
